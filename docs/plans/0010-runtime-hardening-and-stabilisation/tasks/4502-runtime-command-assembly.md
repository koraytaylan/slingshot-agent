...
3. Install the built product without a source checkout and execute supported immediate reads/mutations from real transport envelopes, verifying independent side effects and outcomes.

- **Done when:** The installed package advertises and successfully executes its supported registry commands using packaged data and active adapters, and never accepts work for a missing implementation.
