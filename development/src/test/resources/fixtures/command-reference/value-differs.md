...
| `create_page` | read | required | 16384 | `mutation_outcome_unknown`, `parent_access_denied`, `parent_not_found`, `property_rejected`, `repository_commit_failed`, `target_already_exists`, `template_invalid`, `template_not_found` |
